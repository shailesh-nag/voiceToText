...
public class ChatbotWithMic extends BaseFragment {
    private static final int SPEECH_REQUEST_CODE = 100;
    private final String URL = "https://chatbot-mobile.azurewebsites.net/VirtualAssistant/";
...
// This is where you process the intent and extract the speech text from the intent.
    ...
    {
           Tools.showToast(mContext,"Works"+message);
        //String item = "callWithData";
        webview.loadUrl("javascript:voiceCallbackByAndroid('"+message+"');");

        String js = "javascript:voiceCallbackByAndroid('"+message+"');";
        //   wv.loadUrl(js);
